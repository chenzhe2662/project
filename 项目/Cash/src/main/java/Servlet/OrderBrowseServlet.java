...
public class OrderBrowseServlet extends HttpServlet {
    ...
    private OrderItem extractOrderItem(ResultSet resultSet) throws SQLException {
        ...
        orderItem.setId(resultSet.getInt("orderId"));
        orderItem.setGoodsId(resultSet.getInt("goodsId"));
        orderItem.setGoodsName(resultSet.getString("goodsName"));
        orderItem.setGoodsIntroduce(resultSet.getString("goodsIntroduce"));
        orderItem.setGoodsNum(resultSet.getInt("goodsNum"));
        orderItem.setGoodsUnit(resultSet.getString("goodsUnit"));
        orderItem.setGoodsPrice(resultSet.getInt("goodsPrice"));
        orderItem.setGoodsDiscount(resultSet.getInt("goodsDiscount"));
        return orderItem;
    }
